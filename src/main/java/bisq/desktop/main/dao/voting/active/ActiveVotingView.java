...
@FxmlView
public class ActiveVotingView extends BaseProposalView implements BsqBalanceListener {
                        ...
                        if (item != null && !empty) {
                            if (node == null) {
                                ...
                                item.setOnRemoveHandler(() -> {
                                    ActiveVotingView.this.selectedProposalListItem = item;
                                    ActiveVotingView.this.onRemove();
                                });
