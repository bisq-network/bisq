...
@FxmlView
public abstract class ActiveView extends BaseProposalView implements BsqBalanceListener {

    protected Button removeButton, acceptButton, rejectButton, removeMyVoteButton, voteButton;
    protected InputTextField stakeInputTextField;
    protected List<Node> voteViewItems = new ArrayList<>();
    ...
    @Inject
    protected ActiveView(DaoFacade daoFacade,
    ...
    protected void changeVoteViewItemsVisibility(boolean value) {
                        ...
                        if (item != null && !empty) {
                            if (node == null) {
                                ...
                                item.setOnRemoveHandler(() -> {
                                    ActiveView.this.selectedProposalListItem = item;
                                    ActiveView.this.onRemove();
                                });
