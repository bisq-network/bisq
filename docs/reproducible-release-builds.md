...
The manual GitHub Actions workflow `Installer Evidence` can generate Linux and
macOS installer evidence for a release commit or tag without making installer
...
- optional Windows installer evidence workflow
