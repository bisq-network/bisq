...
public class OfferBookListItemMaker {
    ...
    public static final Instantiator<OfferBookListItem> OfferBookListItem = lookup ->
            new OfferBookListItem(make(btcUsdOffer.but(
                    ...
                    with(OfferMaker.direction, lookup.valueOf(direction, OfferPayloadBase.Direction.BUY)),
    ...
    public static final Maker<OfferBookListItem> btcSellItem = a(OfferBookListItem, with(direction, OfferPayloadBase.Direction.SELL));
