...
public class OfferBookChartViewModelTest {
    ...
    public void testMaxCharactersForBuyPriceWithNoOffers() {
        ...
        final OfferBookChartViewModel model = new OfferBookChartViewModel(offerBook, empty, null, null, null, new ImmutableCoinFormatter());
    ...
    public void testMaxCharactersForBuyPriceWithOfflinePriceFeedService() {
        ...
        final OfferBookChartViewModel model = new OfferBookChartViewModel(offerBook, empty, priceFeedService, null, null, new ImmutableCoinFormatter());
        model.activate();
        assertEquals(0, model.maxPlacesForBuyPrice.intValue());
    }
    ...
    public void testMaxCharactersForFiatBuyPrice() {
        ...
        final OfferBookChartViewModel model = new OfferBookChartViewModel(offerBook, empty, service, null, null, new ImmutableCoinFormatter());
        model.activate();
