...
public class AltCoinAddressValidatorTest {
    ...
    public void testPSD() {
        AltCoinAddressValidator validator = new AltCoinAddressValidator();
        validator.setCurrencyCode("PSD");

        assertTrue(validator.validate("P9sVXQ4ywwRNbm2VmKsFSG4X1nPoyxhuuN").isValid);
        assertTrue(validator.validate("PC3SwqsJCdMt2qAN76tvjfLaeamd8hBR91").isValid);
        assertTrue(validator.validate("PJbfJ23jpjUM8HRDhCHjx89iUXxcUPnWWD").isValid);
        assertTrue(validator.validate("PLQDvkEYzhakY5SstMdRHdh157j1QkKjfo").isValid);

        assertFalse(validator.validate("PLQDvkEYzhakY5SstMdRHdh157j1QkKjfo13422").isValid);
        assertFalse(validator.validate("PLQDvkEYzhakY5Sdh157j1QkKjfo").isValid);
        assertFalse(validator.validate("PLQDvkEYzhakY5SstMdRHdh157j1QkKjfo#").isValid);
        assertFalse(validator.validate("").isValid);
    }
