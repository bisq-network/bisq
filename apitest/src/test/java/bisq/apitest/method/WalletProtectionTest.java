...
public class WalletProtectionTest extends MethodTest {
    ...
    public void testGetBalanceOnEncryptedWalletShouldThrowException() {
        Throwable exception = assertThrows(StatusRuntimeException.class, this::getAliceBalance);
    ...
    public void testUnlockWalletFor4Seconds() {
        ...
        getAliceBalance(); // should not throw 'wallet locked' exception
    ...
    public void testUnlockWalletTimeoutOverride() {
        ...
        sleep(5000);
        getAliceBalance();   // getbalance 5s after resetting unlock timeout to 6s
    }
