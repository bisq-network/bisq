 ...
 */
public class BtcMainNetParams extends AbstractBitcoinNetParams {
    ...
    private static BtcMainNetParams instance;

    public static synchronized BtcMainNetParams get() {
        if (instance == null) {
            instance = new BtcMainNetParams();
        }
        return instance;
    }
