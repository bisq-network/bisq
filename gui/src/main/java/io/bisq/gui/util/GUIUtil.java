    ...
    public static void exportAccounts(ArrayList<PaymentAccount> accounts, String fileName,
        ...
        if (!accounts.isEmpty()) {
            ...
            if (directory != null && !directory.isEmpty()) {
                ...
                paymentAccountsStorage.initAndGetPersisted(new PaymentAccountList(accounts), fileName, 300);
    ...
    public static void importAccounts(User user, String fileName, Preferences preferences, Stage stage,
        ...
        if (file != null) {
            ...
            if (Paths.get(path).getFileName().toString().equals(fileName)) {
                ...
                PaymentAccountList persisted = paymentAccountsStorage.initAndGetPersistedWithFileName(fileName, 300);
                if (persisted != null) {
