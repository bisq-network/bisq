...
public class BanListWindow extends Overlay<BanListWindow> {
    private static final Logger log = LoggerFactory.getLogger(BanListWindow.class);
    ...
    public BanListWindow onAddAlertMessage(SendAlertMessageHandler sendAlertMessageHandler) {
        this.sendAlertMessageHandler = sendAlertMessageHandler;
        return this;
    }

    public BanListWindow onRemoveAlertMessage(RemoveAlertMessageHandler removeAlertMessageHandler) {
