...
echo mvn exec:java -Dexec.mainClass="network.bisq.api.app.HttpApiMain" -Dexec.args="$ARGS"
mvn exec:java -Dexec.mainClass="network.bisq.api.app.HttpApiMain" -Dexec.args="$ARGS"
