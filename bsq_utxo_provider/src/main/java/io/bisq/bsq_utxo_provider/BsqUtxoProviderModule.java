...
class BsqUtxoProviderModule extends AppModule {
    private static final Logger log = LoggerFactory.getLogger(BsqUtxoProviderModule.class);

    public BsqUtxoProviderModule(Environment env) {
        super(env);
    }
