...
public class TempTxOutputCanonicalEncoderTest {
    ...
    public void schemaLocksFieldOrderTypesAndRules() {
        ...
        CanonicalSchema<?> txOutputSchema = TempTxOutput.SCHEMA.getFields().get(7).getSchema();
        assertEquals(List.of(1, 2, 3), fieldNumbers(txOutputSchema));
        assertEquals(List.of(
                        CanonicalSchema.FieldType.ENUM,
                        CanonicalSchema.FieldType.INT32,
                        CanonicalSchema.FieldType.INT32),
                fieldTypes(txOutputSchema));
    }
