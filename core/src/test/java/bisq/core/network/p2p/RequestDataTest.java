...
public class RequestDataTest extends FileDatabaseTestUtils {
    ...
    public void query() throws Exception {
        ...
        P2PDataStorage DUT = new P2PDataStorage(new LocalhostNetworkNode(9999, null), null, loadDatabase(),
                new ProtectedDataStoreService(), null, new SequenceNumberStorageFake(), null, 0);
