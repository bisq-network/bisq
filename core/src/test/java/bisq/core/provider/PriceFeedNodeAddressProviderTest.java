...
public class PriceFeedNodeAddressProviderTest {
    ...
    @Test
    void keepsLocalPriceRelayNodeBansWhenNetworkFilterIgnored() {
        Properties properties = new Properties();
        ...
        assertEquals("http://baz.onion/", provider.getBaseUrl());
        assertEquals(List.of("bar", "foo"), provider.getBannedNodes());
    }
}
