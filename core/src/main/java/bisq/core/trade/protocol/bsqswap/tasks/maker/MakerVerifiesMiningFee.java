...
@Slf4j
public class MakerVerifiesMiningFee extends SetupTxListener {

    @SuppressWarnings({"unused"})
    public MakerVerifiesMiningFee(TaskRunner<BsqSwapTrade> taskHandler, BsqSwapTrade bsqSwapTrade) {
