...
@Slf4j
public class SellerFinalizesOwnWarningTx extends TradeTask {
    public SellerFinalizesOwnWarningTx(TaskRunner<Trade> taskHandler, Trade trade) {
    ...
    protected void run() {
        try {
            ...
            Coin inputValue = processModel.getDepositTx().getOutput(0).getValue();
