...
@Slf4j
public class TakerProcessesProvideInputsForDepositTxMessage extends TradeTask {
    @SuppressWarnings({"unused"})
    public TakerProcessesProvideInputsForDepositTxMessage(TaskRunner taskHandler, Trade trade) {
