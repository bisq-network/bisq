 ...
 */
@Slf4j
public class SellerSendsDepositTxAndSellerPaymentAccountMessage extends SendMailboxMessageTask {
    private static final int MAX_RESEND_ATTEMPTS = 7;
    private int delayInSec = 4;
    private int resendCounter = 0;
    private DepositTxAndSellerPaymentAccountMessage message;
    private ChangeListener<MessageState> listener;
    private Timer timer;

    public SellerSendsDepositTxAndSellerPaymentAccountMessage(TaskRunner<Trade> taskHandler, Trade trade) {
    ...
    protected TradeMailboxMessage getTradeMailboxMessage(String tradeId) {
        if (message == null) {
            ...
            message = new DepositTxAndSellerPaymentAccountMessage(
                    deterministicId,
