...
@Slf4j
public class SignCanceledTradePayoutTx extends TradeTask {

    @SuppressWarnings({"unused"})
    public SignCanceledTradePayoutTx(TaskRunner taskHandler, Trade trade) {
    ...
    protected void run() {
        try {
            ...
            Coin buyerPayoutAmount = Coin.valueOf(processModel.getBuyerPayoutAmountFromCanceledTrade());
            Coin sellerPayoutAmount = Coin.valueOf(processModel.getSellerPayoutAmountFromCanceledTrade());
            ...
            byte[] canceledTradePayoutTx = processModel.getTradeWalletService().signCanceledTradePayoutTx(
                    depositTx,
                    buyerPayoutAmount,
                    sellerPayoutAmount,
            ...
            processModel.setCanceledTradePayoutTxSignature(canceledTradePayoutTx);
