...
@Slf4j
public class FinalizeCanceledTradePayoutTx extends TradeTask {

    @SuppressWarnings({"unused"})
    public FinalizeCanceledTradePayoutTx(TaskRunner taskHandler, Trade trade) {
    ...
    protected void run() {
        try {
            ...
            Transaction transaction = processModel.getTradeWalletService().finalizeCanceledTradePayoutTx(
                    depositTx,
                    buyerSignature,
                    sellerSignature,
                    buyerPayoutAmount,
