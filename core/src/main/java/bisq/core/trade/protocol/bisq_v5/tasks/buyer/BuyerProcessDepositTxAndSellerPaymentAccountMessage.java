...
public class BuyerProcessDepositTxAndSellerPaymentAccountMessage extends TradeTask {
    public BuyerProcessDepositTxAndSellerPaymentAccountMessage(TaskRunner<Trade> taskHandler, Trade trade) {
    ...
    protected void run() {
        try {
            runInterceptHook();
            var message = checkNotNull((DepositTxAndSellerPaymentAccountMessage) processModel.getTradeMessage());
