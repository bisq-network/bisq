...
public final class AccountAgeWitnessOwnershipProof {
    ...
    public byte[] getSignatureMessage() {
        return getSignatureMessage(protocolVersion,
                profileId,
                witnessHash,
    ...
    private void verifyStructure() {
        checkArgument(protocolVersion == VERSION,
                "Unsupported account age witness ownership protocol version: %s", protocolVersion);
    ...
    public String toString() {
        return "AccountAgeWitnessOwnershipProof{" +
