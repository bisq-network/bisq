...
public class Issuance implements PersistablePayload, NetworkPayload, ImmutableDaoStateModel, Canonical {
    ...
    public static final CanonicalSchema<Issuance> SCHEMA = CanonicalSchema.<Issuance>newBuilder("Issuance")
            .string(1, "tx_id", Issuance::getTxId)
            .int32(2, "chain_height", Issuance::getChainHeight)
            .int64(3, "amount", Issuance::getAmount)
            .string(4, "pub_key", Issuance::getPubKey)
            .string(5, "issuance_type", issuance -> issuance.issuanceType.name())
            .build();
