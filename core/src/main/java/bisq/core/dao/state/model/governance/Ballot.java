...
public final class Ballot implements PersistablePayload, ConsensusCritical, ImmutableDaoStateModel, Canonical {
    ...
    public static final CanonicalSchema<Ballot> SCHEMA = CanonicalSchema.<Ballot>newBuilder()
            .compose(1, Ballot::getProposal, Proposal.getProposalSchemaBuilder().build())
            .compose(2, Ballot::getVote, Vote.SCHEMA)
            .build();
