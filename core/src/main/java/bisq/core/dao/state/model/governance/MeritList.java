...
public class MeritList implements Proto, ConsensusCritical, ImmutableDaoStateModel, Canonical {
    ...
    public static final CanonicalSchema<MeritList> SCHEMA = CanonicalSchema.<MeritList>newBuilder("MeritList")
            .repeatedCompose(1, "merit", MeritList::getList, Merit.SCHEMA)
            .build();
