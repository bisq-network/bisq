...
public class BallotList extends PersistableList<Ballot> implements ConsensusCritical, ImmutableDaoStateModel, Canonical {
    ...
    public static final CanonicalSchema<BallotList> SCHEMA = CanonicalSchema.<BallotList>newBuilder("BallotList")
            .repeatedCompose(1, "ballot", BallotList::getList, Ballot.SCHEMA)
            .build();
