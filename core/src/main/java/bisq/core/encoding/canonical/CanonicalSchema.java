...
public final class CanonicalSchema<T> {
    ...
    public static final class Builder<T> {
        ...
        public Builder<T> int32(int number, ToIntFunction<T> getter) {
            return add(number, FieldType.INT32, Rule.OMIT_DEFAULT,
                    getter::applyAsInt);
        }

        public Builder<T> uint32(int number, ToIntFunction<T> getter) {
            return add(number, FieldType.UINT32, Rule.OMIT_DEFAULT,
                    getter::applyAsInt);
        }

        public Builder<T> int64(int number, ToLongFunction<T> getter) {
            return add(number, FieldType.INT64, Rule.OMIT_DEFAULT,
                    getter::applyAsLong);
        }
        ...
        public Builder<T> enumField(int number, Function<T, ? extends CanonicalEnum> getter) {
            return add(number, FieldType.ENUM, Rule.OMIT_DEFAULT, getter);
        }

        public Builder<T> string(int number, Function<T, String> getter) {
            return add(number, FieldType.STRING, Rule.OMIT_EMPTY, getter);
        }
        ...
        public Builder<T> bytes(int number, Function<T, byte[]> getter) {
            return add(number, FieldType.BYTES, Rule.OMIT_EMPTY, getter);
        }

        public <N> Builder<T> compose(int number,
                                      Function<T, N> getter,
                                      CanonicalSchema<N> schema) {
            return add(number, FieldType.COMPOSE, Rule.OMIT_NULL, getter, schema);
        }

        public <N> Builder<T> extend(int number,
                                     Function<T, N> getter,
                                     CanonicalSchema<N> schema) {
            return add(number, FieldType.EXTEND, Rule.OMIT_NULL, getter, schema);
        }
        ...
        public <N> Builder<T> repeatedCompose(int number,
                                              ...
                                              CanonicalSchema<N> schema) {
            return add(number, FieldType.REPEATED_COMPOSE, Rule.LIST_ORDER, getter, schema);
        }
        ...
        private Builder<T> add(int number,
                               ...
                               Rule rule,
                               Function<T, ?> getter) {
            return add(number, type, rule, getter, null, null);
        }
        ...
        private Builder<T> add(int number,
                               ...
                               @Nullable
                               CanonicalSchema<?> schema) {
            return add(number, type, rule, getter, schema, null);
        }
        ...
        private Builder<T> add(int number,
            ...
            return add(number, type, rule, getter, null, schemaBuilder);
        }
        ...
        private Builder<T> add(int number,
                               ...
                               @Nullable
                               Builder<?> schemaBuilder) {
            return add(number, type, rule, getter, schema, schemaBuilder, null);
        }
        ...
        private Builder<T> add(int number,
            ...
            return add(number, type, rule, getter, null, null, mapEncoding);
        }
