...
//  segwit delayed payout tx vsize = 139
    ...
    private static int BSQ_SWAP_TX_SIZE = 975;
    ...
    public Tuple2<Coin, Integer> getEstimatedBsqSwapFeeAndTxSize(int estimatedInputs, int estimatedOutputs) {
        var txFeePerByte = feeService.getTxFeePerVbyte();
        ...
        var estimatedSize = BSQ_SWAP_TX_SIZE + extraInputSize + extraOutputSize;
