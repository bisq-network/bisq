...
@Slf4j
//TODO same as SellerAsMakerBroadcastPayoutTx
public class BuyerAsTakerBroadcastPayoutTx extends TradeTask {
    @SuppressWarnings({"WeakerAccess", "unused"})
    public BuyerAsTakerBroadcastPayoutTx(TaskRunner taskHandler, Trade trade) {
