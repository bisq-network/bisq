...
public enum BaseCurrencyNetwork {
    ...
    TRKC_MAINNET(TrkcMainNetParams.get(), "TRKC", "MAINNET", "Trukcoin"),
    TRKC_TESTNET(TrkcTestNet3Params.get(), "TRKC", "TESTNET", "Truckcoin"),
    TRKC_REGTEST(TrkcRegTestParams.get(), "TRKC", "REGTEST", "Truckcoin");
