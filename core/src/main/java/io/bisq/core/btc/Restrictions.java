        ...
        if (MIN_TRADE_AMOUNT == null)
            switch (BisqEnvironment.getBaseCurrencyNetwork().getCurrencyCode()) {
                ...
                case "DASH":
                    ...
                    break;
                case "TRKC":
                    MIN_TRADE_AMOUNT = Coin.valueOf(20_000L); // 0.03 EUR at TRKC price 0.003 EUR;
                    break;
            }
        ...
        if (MAX_BUYER_SECURITY_DEPOSIT == null)
            switch (BisqEnvironment.getBaseCurrencyNetwork().getCurrencyCode()) {
                ...
                case "DASH":
                    ...
                    break;
                case "TRKC":
                    MAX_BUYER_SECURITY_DEPOSIT = Coin.valueOf(300_000_000L); // 500 EUR @ 0.0025 EUR/TRKC;
                    break;
            }
        ...
        if (MIN_BUYER_SECURITY_DEPOSIT == null)
            switch (BisqEnvironment.getBaseCurrencyNetwork().getCurrencyCode()) {
                ...
                case "DASH":
                    ...
                    break;
                case "TRKC":
                    MIN_BUYER_SECURITY_DEPOSIT = Coin.valueOf(1_500_600L); // 2.5 EUR @ 0.0025 EUR/TRKC;
                    break;
            }
