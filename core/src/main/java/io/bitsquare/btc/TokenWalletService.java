...
public class TokenWalletService {
    ...
    @Inject
    public TokenWalletService(RegTestHost regTestHost,
        ...
        this.walletDir = new File(appDir, "squ");
    ...
    public void initialize(@Nullable DeterministicSeed seed, ResultHandler resultHandler, ExceptionHandler exceptionHandler) {
        ...
        walletAppKit = new WalletAppKitBitSquare(params, socks5Proxy, walletDir, "SQU") {
            @Override
