...
public class BittrexPriceProvider extends PriceProvider {
    private static final Logger log = LoggerFactory.getLogger(BittrexPriceProvider.class);

    @Inject
    public BittrexPriceProvider(HttpClient httpClient, Preferences preferences, Socks5ProxyProvider socks5ProxyProvider) {
