...
public class TradeWalletService {
    ...
    public Transaction createTradingFeeTx(Address fundingAddress, Address reservedForTradeAddress, Address changeAddress, Coin reservedFundsForOffer,
        ...
        BtcWalletService.printTxWithInputs("tradingFeeTx", tradingFeeTx);
    ...
    public InputsAndChangeOutput takerCreatesDepositsTxInputs(Coin inputAmount, Coin txFee, AddressEntry takersAddressEntry, Address takersChangeAddress) throws
        ...
        BtcWalletService.printTxWithInputs("dummyTX", dummyTX);
    ...
    public PreparedDepositTxAndOffererInputs offererCreatesAndSignsDepositTx(boolean offererIsBuyer,
        ...
        BtcWalletService.printTxWithInputs("preparedDepositTx", preparedDepositTx);
    ...
    public Transaction takerSignsAndPublishesDepositTx(boolean takerIsSeller,
        ...
        BtcWalletService.printTxWithInputs("offerersDepositTx", offerersDepositTx);
        ...
        BtcWalletService.printTxWithInputs("depositTx", depositTx);
    ...
    public byte[] sellerSignsPayoutTx(Transaction depositTx,
        ...
        BtcWalletService.printTxWithInputs("preparedPayoutTx", preparedPayoutTx);
    ...
    public Transaction buyerSignsAndFinalizesPayoutTx(Transaction depositTx,
        ...
        BtcWalletService.printTxWithInputs("payoutTx", payoutTx);
    ...
    public Transaction traderSignAndFinalizeDisputedPayoutTx(byte[] depositTxSerialized,
        ...
        BtcWalletService.printTxWithInputs("disputed payoutTx", payoutTx);
