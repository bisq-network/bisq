 ...
 */
public class OfferTableBuilder extends AbstractTableBuilder {
    ...
    public OfferTableBuilder(List<?> protos) {
    ...
    public Table buildFiatOfferTable(List<OfferInfo> offers) {
        ...
        Column<Long> colFiatPrice = new FiatColumn(format(COL_HEADER_PRICE, fiatTradeCurrency.get()));
        ...
        ZippedStringColumns volumeRange =
                new ZippedStringColumns(format(COL_HEADER_VOLUME, fiatTradeCurrency.get()),
                        RIGHT,
                        " - ",
    ...
    public Table buildCryptoCurrencyOfferTable(List<OfferInfo> offers) {
        @Nullable
        Column<String> colEnabled = enabledColumn.get(); // Not boolean: YES, NO, or PENDING
        Column<Long> colBtcPrice = new SatoshiColumn(format(COL_HEADER_PRICE_OF_ALTCOIN, altcoinTradeCurrency.get()));
        ...
        ZippedStringColumns amountRange = zippedAmountRangeColumns.get();
        ZippedStringColumns volumeRange =
                new ZippedStringColumns(format(COL_HEADER_VOLUME, altcoinTradeCurrency.get()),
                        RIGHT,
                        " - ",
    ...
    private final Supplier<ZippedStringColumns> zippedAmountRangeColumns = () -> {
        ...
        return new ZippedStringColumns(COL_HEADER_AMOUNT,
                RIGHT,
                " - ",
