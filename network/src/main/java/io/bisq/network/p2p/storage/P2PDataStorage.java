...
public class P2PDataStorage implements MessageListener, ConnectionListener, PersistedDataHost {
    ...
    public synchronized void readEntryMapFromResources(String resourceFileName) {
        ...
        persistableEntryMap = persistedEntryMapStorage.<HashMap<ByteArray, MapValue>>initAndGetPersistedWithFileName(storageFileName, 300);
    ...
    public synchronized void readPersistableNetworkPayloadMapFromResources(String resourceFileName) {
        ...
        persistableNetworkPayloadCollection = persistableNetworkPayloadMapStorage.initAndGetPersistedWithFileName(storageFileName, 300);
